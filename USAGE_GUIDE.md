...
- `30_upgrade_repo/31a_upgrade_repo.ts`
  - Upgrades the plugin repo to the latest Aragon OSx protocol version.
- `30_upgrade_repo/31b_upgrade_and_reinitialize_repo.ts`
  - Upgrades the plugin repo to the latest Aragon OSx protocol version and re-initializes it by calling the `initializeFrom` function.
